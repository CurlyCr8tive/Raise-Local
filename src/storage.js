...
export const DEMO_DATA = {
  campaignRequests: [
    ...
    },
    {
      ...
      organizationName: "YES Academy Inc.",
      organizationType: "501(c)(3) nonprofit",
      ...
      classification: "501(c)(3)",
      communitiesServed: "Harlem youth, families, mentors, and community donors",
      mission: "Support Harlem youth through education, enrichment, and community programs.",
      audienceServed: "Youth ages 4-18, families, mentors, and community donors",
      audienceSize: 400,
      campaignDescription: "Cookies for the Toy Drive: a share of holiday cookie sales funds YES Academy's Harlem Care Toy Drive.",
      fundingGoal: 4000,
      ...
      supportNeeds: ["Food & beverage", "Products or corporate gifting"],
      geography: "Manhattan",
      mustHaves: "Manhattan (Harlem) service area, youth-focused partner, capacity for at least 60 participants.",
      niceToHaves: "A warm local brand, seasonal campaign energy, and social media cross-promotion.",
      priorFundraiser: "No",
      status: "new",
    },
  ],
