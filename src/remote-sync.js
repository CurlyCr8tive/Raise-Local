...
function toRequestRow(request) {
  return {
    ...
    campaign_type: request.campaignType || request.eventType || "",
...
function toBusinessRow(business) {
  return {
    ...
    pricing_point: business.pricingPoint || business.averagePriceRange || "",
...
function fromRequestRow(row) {
  return {
    ...
    campaignType: row.campaign_type || row.event_type || "",
...
function fromBusinessRow(row) {
  return {
    ...
    pricingPoint: row.pricing_point || row.average_price_range || "",
